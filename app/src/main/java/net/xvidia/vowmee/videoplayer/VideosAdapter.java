...
public class VideosAdapter extends RecyclerView.Adapter<VideosAdapter.ViewHolder> {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View v) {
            ...
            textView = (TextView) v.findViewById(R.id.timeline_post_user);
            progressBar = (ProgressBar) v.findViewById(R.id.progressBar);
            videoPlayer = (VideoPlayer) v.findViewById(R.id.timeline_videoplayer);
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        screenWidthDp = screenWidthDp+(screenWidthDp/3);
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        holder.textView.setText("Video " + video.getUrl());
...
//        holder.layout.addView(videoPlayer);
        videoPlayerController.loadVideo(video, holder.videoPlayer, holder.progressBar);
//        holder.videoPlayer.setOnClickListener(new View.OnClickListener() {
//            @Override
//            public void onClick(View v) {
//
//                holder.videoPlayer.changePlayState();
//            }
//        });
    }
