package net.xvidia.vowmee.camera;
...
public class CameraHelper {
    ...
    public static Camera getDefaultBackFacingCameraInstance() {
        Camera camera = getDefaultCamera(Camera.CameraInfo.CAMERA_FACING_BACK);
        if(camera != null)
    ...
    public static Camera getDefaultFrontFacingCameraInstance() {
        Camera camera = getDefaultCamera(Camera.CameraInfo.CAMERA_FACING_FRONT);
        if(camera != null)
    ...
    public static void setDefaultCameraId() {
